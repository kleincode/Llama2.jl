"""
Configuration of intitial parameters

llama.c correspondence Config (l.19)
"""
struct Config
    ...
    function Config(dim::Int32, hidden_dim::Int32, n_layers::Int32, n_heads::Int32, n_kv_heads::Int32, vocab_size::Int32, seq_len::Int32)
        # Input checks
        ...
        n_layers > 0 || throw(ArgumentError("The number of layers must be bigger than zero"))
        n_heads > 0 || throw(ArgumentError("The number of query heads must be bigger than zero"))
        n_kv_heads > 0 || throw(ArgumentError("The number of key/value heads must be bigger than zero"))
